...
После запуска `python -m product_master` ценовые строки получают `master_product_id`, общий для соответствующих карточек всех площадок и их тестовых вариантов.
