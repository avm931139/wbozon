...
- [Документы и бухгалтерия Ozon](../ozon/ACCOUNTING.md)
- [Сверка FBO-поставок Ozon](../ozon/SUPPLY_RECONCILIATION.md)
...
Файлы в `dialog_history/` фиксируют исторические обсуждения и могут содержать уже реализованные планы. Они не являются инструкцией по текущему запуску.
