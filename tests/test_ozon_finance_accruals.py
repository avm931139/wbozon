...
def test_finance_api_contracts_and_pagination():
    client = Client([
        ...
        {"posting_accruals": [{"posting_number": "123-1", "accruals": []}]},
    ])
    ...
    assert api.accruals_by_postings(["123-1"])[0]["posting_number"] == "123-1"
...
def test_finance_sync_persists_daily_types_and_posting_details():
    ...
    with sessions() as session:
        ...
        assert daily.posting_number == "123-1"
