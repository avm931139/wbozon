...
from app.config import (
    ...
    OZON_SUPPLY_RECONCILIATION_MAX_AGE_SECONDS,
    WB_TG_BOT_TOKEN,
    WB_TG_CHAT_ID,
    WB_TG_MORNING_TIME,
    WB_TG_PROXY_URL,
    ...
    YANDEX_MARKET_ANALYTICS_MAX_AGE_SECONDS,
    YANDEX_MARKET_CATALOG_MAX_AGE_SECONDS,
    YANDEX_MARKET_FINANCE_MAX_AGE_SECONDS,
...
OZON_TASK_MAX_AGES = {
    ...
    "supply_reconciliation": OZON_SUPPLY_RECONCILIATION_MAX_AGE_SECONDS,
    ...
    "documents": OZON_ACCOUNTING_MAX_AGE_SECONDS,
