...
WB_ORDER_FEED_LOOKBACK_DAYS = int(os.getenv("WB_ORDER_FEED_LOOKBACK_DAYS", "31"))
WB_ORDER_FEED_MAX_AGE_SECONDS = int(os.getenv("WB_ORDER_FEED_MAX_AGE_SECONDS", "1200"))
...
WB_TG_OPERATIONAL_INTERVAL_SECONDS = int(os.getenv("WB_TG_OPERATIONAL_INTERVAL_SECONDS", "3600"))
...
OZON_SUPPLY_RECONCILIATION_REQUEST_PAUSE_SECONDS = float(
    os.getenv("OZON_SUPPLY_RECONCILIATION_REQUEST_PAUSE_SECONDS", "1.0")
)
OZON_SUPPLY_RECONCILIATION_RATE_LIMIT_RETRIES = int(
    os.getenv("OZON_SUPPLY_RECONCILIATION_RATE_LIMIT_RETRIES", "4")
)
OZON_SUPPLY_RECONCILIATION_RATE_LIMIT_BACKOFF_SECONDS = float(
    os.getenv("OZON_SUPPLY_RECONCILIATION_RATE_LIMIT_BACKOFF_SECONDS", "30")
)
