...
WB_SALES_FUNNEL_LOOKBACK_DAYS = int(os.getenv("WB_SALES_FUNNEL_LOOKBACK_DAYS", "7"))
WB_SALES_FUNNEL_REQUEST_INTERVAL_SECONDS = float(
    os.getenv("WB_SALES_FUNNEL_REQUEST_INTERVAL_SECONDS", "20")
)
WB_SALES_FUNNEL_MAX_AGE_SECONDS = int(os.getenv("WB_SALES_FUNNEL_MAX_AGE_SECONDS", "7200"))
WB_WAREHOUSE_REMAINS_POLL_SECONDS = float(
    os.getenv("WB_WAREHOUSE_REMAINS_POLL_SECONDS", "5")
)
WB_WAREHOUSE_REMAINS_POLL_ATTEMPTS = int(
    os.getenv("WB_WAREHOUSE_REMAINS_POLL_ATTEMPTS", "12")
)
...
# Cabinet financial exports reconciliation. Input files are never modified or deleted.
FINANCE_RECONCILIATION_INBOX = os.getenv(
    "FINANCE_RECONCILIATION_INBOX", "data/finance_reconciliation/inbox"
)
FINANCE_RECONCILIATION_REPORTS = os.getenv(
    "FINANCE_RECONCILIATION_REPORTS", "data/finance_reconciliation/reports"
)
FINANCE_RECONCILIATION_YANDEX_API_DIR = os.getenv(
    "FINANCE_RECONCILIATION_YANDEX_API_DIR", "data/yandex_market/finance"
)
FINANCE_RECONCILIATION_TOLERANCE = os.getenv("FINANCE_RECONCILIATION_TOLERANCE", "0.01")
FINANCE_RECONCILIATION_TG_CHAT_ID = (
    os.getenv("FINANCE_RECONCILIATION_TG_CHAT_ID") or OPERATIONS_TG_CHAT_ID
)
FINANCE_RECONCILIATION_TG_BOT_TOKEN = (
    os.getenv("FINANCE_RECONCILIATION_TG_BOT_TOKEN") or OPERATIONS_TG_BOT_TOKEN
)
FINANCE_RECONCILIATION_TG_PROXY_URL = (
    os.getenv("FINANCE_RECONCILIATION_TG_PROXY_URL") or OPERATIONS_TG_PROXY_URL
)

DASHBOARD_HOST = os.getenv("DASHBOARD_HOST", "127.0.0.1")
DASHBOARD_PORT = int(os.getenv("DASHBOARD_PORT", "17843"))
...
OZON_DAILY_SALES_RATE_LIMIT_RETRIES = int(
    os.getenv("OZON_DAILY_SALES_RATE_LIMIT_RETRIES", "2")
)
OZON_DAILY_SALES_RATE_LIMIT_BACKOFF_SECONDS = float(
    os.getenv("OZON_DAILY_SALES_RATE_LIMIT_BACKOFF_SECONDS", "60")
)
...
OZON_FINANCE_POSTING_BATCH_LIMIT = int(
    os.getenv("OZON_FINANCE_POSTING_BATCH_LIMIT", "25")
)
OZON_FINANCE_POSTING_REQUEST_PAUSE_SECONDS = float(
    os.getenv("OZON_FINANCE_POSTING_REQUEST_PAUSE_SECONDS", "1.0")
)
OZON_FINANCE_RATE_LIMIT_RETRIES = int(os.getenv("OZON_FINANCE_RATE_LIMIT_RETRIES", "4"))
OZON_FINANCE_RATE_LIMIT_BACKOFF_SECONDS = float(
    os.getenv("OZON_FINANCE_RATE_LIMIT_BACKOFF_SECONDS", "30")
)
...
PRODUCT_CATALOG_SYNC_REQUIRED = _env_bool("PRODUCT_CATALOG_SYNC_REQUIRED", False)
