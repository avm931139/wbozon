...
чистой выручке внутри площадки и финансового дня. WB и Ozon используют прямую
товарную рекламную статистику. Текущие отчёты Яндекс Маркета не содержат SKU,
поэтому его рекламный расход распределяется по выручке с явной меткой метода.
